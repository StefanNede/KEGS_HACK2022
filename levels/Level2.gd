...
var waves = [
	["punch","punch","punch","punch","punch", "shoot"], 
	["punch","punch","punch","punch","punch", "punch", "shoot", "shoot"],
	["punch","punch","punch","punch","punch", "shoot", "shoot", "shoot"]
]
var waves_enemy = [6,8,8]
...
func show_dialogue():
	...
	dialogue.text = "It seems you have found a candy cane sword! It does 40 damage which is twice as much as your punches (switch to it with 2). Keep going!!!"
