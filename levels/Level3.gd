...
var waves = [
	["punch","punch","punch","shoot","shoot","reindeer"], 
	["punch","punch","shoot","shoot","shoot","reindeer","reindeer"],
	["punch","punch","punch", "shoot", "shoot", "shoot", "reindeer", "reindeer"]
]
var waves_enemy = [6,7,8]
