...
func show_dialogue():
	...
	dialogue.text = "The grenade launcher does 100 damage to where you click but you only have 3 grenades. The Ice Witches can freeze you if they hit you 5 times!!"
